/* 
This file implements the methods that provide access to the database.
The parameter is defined in the SQL query and is denoted with an initial $ character.
*/
