...
export class SqlRepository implements Repository {
  ...
  executeQuery(sql: string, params: any): Promise<Result[]> {
    return new Promise<Result[]>((resolve, reject) => {
      // The all method executes a SQL statement with an optional
      // set of parameters and passes all result rows to the callback
      // function as an array of type Result.
